...
const Profile: React.FC = () => {
  ...
  return (
    <div className="profile-page">
      <AppHeader title="Meu Perfil" rightAction={<Settings size={24} className="text-primary" />} />
      ...
      <main className="content">
        ...
        <section className="history-section p-4">
          <div className="section-header flex justify-between items-center mb-4">
            ...
            <span className="text-primary text-sm font-medium">Ver tudo</span>
          </div>
        ...
        <section className="action-menu p-4 flex-col gap-2">
          ...
          <Button variant="ghost" className="menu-btn" icon={<Trophy size={20} />}>Meu Ranking</Button>
